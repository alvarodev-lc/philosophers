    ...
    ; a 1.
    ; The result of calling this function is bit 0 of file register parameter 
    ; set to 1 (locked) in any circunstance.
...
_TSlock:
    ...
    BTSTS.Z [W0], #0
    BRA	    Z, itWasFree    ; Then the function asnwer is 0
    MOV	    #0x1, W2	    ; Otherwise the function asnwer is 1
    MOV	    W2, [W1]
    GOTO    endTSlock
itWasFree:
    MOV	    #0x0, W2
...
_asmStackFrame: 
    ...
    ; Push task start address of code (high word address = 0000)
    MOV	    _task_code_address, W0
    PUSH    W0
    ...
    ; This saves context of current running task, then call scheduller and
